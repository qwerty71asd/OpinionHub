    ...
    public partial class InitIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PollAllowedUsers", x => new { x.PollId, x.UserId });
                    table.ForeignKey(
                        name: "FK_PollAllowedUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PollId = table.Column<Guid>(type: "uuid", nullable: false),
                    VoterAccountId = table.Column<string>(type: "text", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoteSelections", x => new { x.VoteId, x.PollOptionId });
                    table.ForeignKey(
                        name: "FK_VoteSelections_PollOptions_PollOptionId",
                        column: x => x.PollOptionId,
                        principalTable: "PollOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VoteSelections_Votes_VoteId",
                        column: x => x.VoteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Polls_Status_EndDateUtc",
                table: "Polls",
                columns: new[] { "Status", "EndDateUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Votes_PollId_VoterAccountId",
                table: "Votes",
                columns: new[] { "PollId", "VoterAccountId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VoteSelections_PollOptionId",
                table: "VoteSelections",
                column: "PollOptionId");
        }
