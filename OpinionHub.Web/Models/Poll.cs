...
public class Poll
{
    ...
    /// <summary>
    /// Опрос опубликован «как Аноним». Имя/ссылка на профиль скрывается в ленте, Details
    /// и комментариях; бейджи «Автор»/«Лайк от автора» в комментариях не показываются.
    /// На Telegram-рассылку влияет: уведомление уходит только подписчикам с включённой
    /// опцией ApplicationUser.NotifyAnonymousPolls.
    /// </summary>
    public bool IsAnonymousAuthor { get; set; } = false;
}
